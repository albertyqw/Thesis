function [errors, energies, imPred] = dAR(M, cdk, b, c, x, label ...
    ...
    v0 = x; % keeps x the original test image
    v0([1:5 29:33 57:61 85:89]) = 1; % adding "dot-probe"
    v0 = v0';
    ...
    for i = 1:cycles
        ...
        imPred = sum(vk(785:812))/length(vk(785:812))*10; % predicted valence
